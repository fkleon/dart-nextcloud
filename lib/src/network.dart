...
class NextCloudHttpClient extends HttpClient {
  ...
  factory NextCloudHttpClient.withCredentials(String username,
      String password,
      AppType appType,
      String language,) =>
      NextCloudHttpClient(
  ...
  factory NextCloudHttpClient.withAppPassword(String appPassword,
      AppType appType,
      String language,) =>
      NextCloudHttpClient(
        'Bearer $appPassword',
  ...
  factory NextCloudHttpClient.withoutLogin(AppType appType,
      String language,) =>
      NextCloudHttpClient(
        '',
        appType,
...
class Network {
  ...
  Future<http.Response> send(String method,
      String url,
  ...
  /// send the request with given [method] and [url]
  Future<http.StreamedResponse> download(String method,
      String url,
      List<int> expectedCodes, {
        Uint8List data,
        Map<String, String> headers,
